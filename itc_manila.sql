...
CREATE TABLE `collections` (
  ...
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  `official_receipt_id` int(11) DEFAULT NULL,
  ...
  `deposit_channel` int(11) DEFAULT NULL,
  `clearing_type_code` int(11) DEFAULT NULL,
  `drawee_bank_code` varchar(155) DEFAULT NULL,
  `drawee_bank_branch_code` varchar(155) DEFAULT NULL,
  `check_pickup_date` date DEFAULT NULL,
  `collector_remarks` text,
  `itinerary_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_collections_lookups1_idx` (`collection_type`),
  KEY `fk_collections_official_receipts1_idx` (`official_receipt_id`),
  KEY `fk_collections_collectors1_idx` (`collector_id`),
  KEY `fk_collections_itineraries1_idx` (`itinerary_id`),
  CONSTRAINT `fk_collections_collectors1` FOREIGN KEY (`collector_id`) REFERENCES `collectors` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_collections_itineraries1` FOREIGN KEY (`itinerary_id`) REFERENCES `itineraries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_collections_official_receipts1` FOREIGN KEY (`official_receipt_id`) REFERENCES `official_receipts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `official_receipts` VALUES (54,1,1,5,3,'AB000009',3,'2014-06-13','2014-06-13 09:23:15','2014-06-15 13:44:04'),(55,1,1,5,3,'AB000010',5,'2014-06-13','2014-06-13 09:23:15','2014-06-21 13:20:42'),(56,1,1,5,3,'AB000011',5,'2014-06-13','2014-06-13 09:23:15','2014-06-21 13:20:42'),(57,1,1,5,3,'AB000012',5,'2014-06-13','2014-06-13 09:23:15','2014-06-21 13:20:42'),(58,1,1,5,3,'AB000013',5,'2014-06-13','2014-06-13 09:23:16','2014-06-21 13:20:42'),(59,1,1,5,3,'AB000014',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(60,1,1,5,3,'AB000015',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(61,1,1,5,3,'AB000016',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(62,1,1,5,3,'AB000017',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(63,1,1,5,3,'AB000018',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(64,1,1,5,3,'AB000019',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(65,1,1,5,3,'AB000020',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(66,1,1,5,3,'AB000021',4,'2014-06-13','2014-06-13 09:23:16','2014-06-21 12:08:57'),(67,1,1,5,3,'ABC000009',4,'2014-06-13','2014-06-13 09:31:51','2014-06-21 12:08:57'),(68,NULL,1,5,3,'CBC000009',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(69,NULL,1,5,3,'CBC000010',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(70,NULL,1,5,3,'CBC000011',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(71,NULL,1,5,3,'CBC000012',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(72,NULL,1,5,3,'CBC000013',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(73,NULL,1,5,3,'CBC000014',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(74,NULL,1,5,3,'CBC000015',1,'2014-06-15','2014-06-15 13:27:35','2014-06-15 13:27:35'),(75,1,1,5,3,'ACC000009',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(76,1,1,5,3,'ACC000010',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(77,1,1,5,3,'ACC000011',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(78,1,1,5,3,'ACC000012',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(79,1,1,5,3,'ACC000013',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(80,1,1,5,3,'ACC000014',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(81,1,1,5,3,'ACC000015',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(82,1,1,5,3,'ACC000016',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(83,1,1,5,3,'ACC000017',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(84,1,1,5,3,'ACC000018',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(85,1,1,5,3,'ACC000019',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(86,1,1,5,3,'ACC000020',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46'),(87,1,1,5,3,'ACC000021',2,'2014-06-25','2014-06-25 07:56:25','2014-06-25 07:56:46');
...
INSERT INTO `trip_areas` VALUES (18,15,4,'2014-06-04 15:31:06','2014-06-04 15:31:06'),(19,15,1,'2014-06-04 15:31:06','2014-06-04 15:31:06'),(20,15,4,'2014-06-04 15:31:56','2014-06-04 15:31:56'),(21,15,1,'2014-06-04 15:31:56','2014-06-04 15:31:56'),(22,15,15,'2014-06-04 15:31:56','2014-06-04 15:31:56'),(23,15,4,'2014-06-25 04:49:28','2014-06-25 04:49:28'),(24,15,1,'2014-06-25 04:49:28','2014-06-25 04:49:28'),(25,15,15,'2014-06-25 04:49:28','2014-06-25 04:49:28');
...
INSERT INTO `trips` VALUES (15,1,'PC','2014-06-25','2014-06-04 15:31:06','2014-06-25 04:49:28');
