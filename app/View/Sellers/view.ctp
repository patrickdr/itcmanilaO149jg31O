...
<h2><?php echo __('Seller'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($seller['Seller']['name'], array('controller' => 'sellers', 'action' => 'view', $seller['Seller']['id'])); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<?php foreach ($seller['Seller'] as $seller): ?>
		<tr>
